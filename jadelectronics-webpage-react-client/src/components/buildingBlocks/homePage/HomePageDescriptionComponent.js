        ...
        return (
            <div className={'home-page-desc'}>
                <p className={'text-wrap'}>
                    ...
                    <br/><br/>
                    I can’t change everyone in the world, but maybe I can change the way people see the world. I want people to open their eyes, to see the challenges of everyday life, to see the problems, and do something about it.
                    ...
                    <br/><br/>
                    I know quite a few people want to have this mind set but don’t know how to get started, the don't know how to force the mental shift. That’s what I am hoping my page will help. Below I have two links, one for the brain, one for the body. As I have gone through life I have faced things that have challenged my brain, body and way of thinking. I have also challenged myself to force myself to grow and improve. The two links below contain the opinions formed and knowledge developed. So go ahead and take a look around, I have everything from forums to tutorials.
