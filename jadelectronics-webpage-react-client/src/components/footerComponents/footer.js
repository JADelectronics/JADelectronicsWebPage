        ...
        return (
            <footer>
                ...
                <div className={"img-center"}>
                    <img src="http://jadelectronicarts.com:3001/images/getLogoThumbnail" className={"img-center"}></img>
                </div>
                ...
                <Modal show={this.state.showResumeModal} onHide={this.closeResumeModal}>
                    ...
                    <Modal.Body className={"resume-modal-body"}>
                        <embed src="http://jadelectronicarts.com:3001/documents/getResume" frameborder="0" width="100%" height="400px"></embed>
                    </Modal.Body>
                ...
                <Modal show={this.state.showAboutMeModal} onHide={this.closeAboutMeModal}>
                    ...
                    <Modal.Body className={"about-me-modal-body"}>
                        ...
                        <img src="http://jadelectronicarts.com:3001/images/getCatThumbnail" className={"img-left"}></img>
                    </Modal.Body>
